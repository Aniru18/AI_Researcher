...
\bibitem{wang2026humanx}
Yinhuai Wang, Qihan Zhao, Yuen Fui Lau, Runyi Yu, Hok Wai Tsui, Qifeng Chen, Jingbo Wang, Jiangmiao Pang, Ping Tan. HumanX: Toward Agile and Generalizable Humanoid Interaction Skills from Human Videos. \textit{arXiv preprint arXiv:2602.02473}, 2026. \href{https://arxiv.org/pdf/2602.02473v1}{https://arxiv.org/pdf/2602.02473v1}

\bibitem{peng2018deepmimic}
Xue Bin Peng, Pieter Abbeel, Sergey Levine, and Michiel van de Panne. Deepmimic. \textit{ACM Transactions on Graphics}, 37:1--14, Aug 2018.

\bibitem{he2025asap}
Tairan He, Jiawei Gao, Wenli Xiao, Yuanhang Zhang, Zi Wang, Jiashun Wang, Zhengyi Luo, Guanqi He, Nikhil Sobanbab, Chaoyi Pan, et al. Asap: Aligning simulation and real-world physics for learning agile humanoid whole-body skills. \textit{arXiv preprint arXiv:2502.01143}, 2025.

\bibitem{tobin2017domain}
Josh Tobin, Rachel Fong, Alex Ray, Jonas Schneider, Wojciech Zaremba, and Pieter Abbeel. Domain randomization for transferring deep neural networks from simulation to the real world. In \textit{2017 IEEE/RSJ international conference on intelligent robots and systems (IROS)}, pages 23--30. IEEE, 2017.

\bibitem{sadeghi2018cad2rl}
F. Sadeghi, A. Lee, D. Stanford, A. O. Alden, K. R. S. Bhat, and S. Levine. Cad2rl: Real single-image flight without a single real image. \textit{Robotics and Automation Letters}, 3(4):3020-3026, 2018.

\bibitem{finn2017model}
Chelsea Finn, Pieter Abbeel, and Sergey Levine. Model-Agnostic Meta-Learning for Fast Adaptation of Deep Networks. \textit{Proceedings of the 34th International Conference on Machine Learning}, 2017.

\bibitem{nagabandi2019learning}
A. Nagabandi, I. Konogliev, S. Levine, and A. Singh. Learning to Adapt in Dynamic, Real-World Environments Through Meta-Reinforcement Learning. \textit{International Conference on Learning Representations}, 2019.

\bibitem{li2021reinforcement}
Z. Li, X. B. Peng, P. Abbeel, S. Levine, G. Berseth, and K. Sreenath. Reinforcement learning for robust parameterized locomotion control of bipedal robots. \textit{2021 IEEE International Conference on Robotics and Automation (ICRA)}, pages 2811-2817, 2021.

\bibitem{eslami2016continuous}
S. M. Eslami, N. Heess, Y. Tassa, and J. Schulman. Continuous control with deep reinforcement learning. \textit{International Conference on Learning Representations}, 2016.

\bibitem{locatello2019graph}
F. Locatello, S. O. Alsallakh, and A. Schwing. Graph-based representation for learning about 3D articulated objects. \textit{Advances in Neural Information Processing Systems}, 32, 2019.

\bibitem{reynolds2021prompt}
L. Reynolds and M. McDonell. Prompt Engineering for Large Language Models. \textit{Proceedings of the 2021 Conference on Empirical Methods in Natural Language Processing}, 2021.

\bibitem{makoviychuk2021isaac}
Viktor Makoviychuk, Lukasz Wawrzyniak, Yunrong Guo, Michelle Lu, Kier Storey, Miles Macklin, David Hoeller, Nikita Rudin, Arthur Allshire, Ankur Handa, and Gavriel State. Isaac gym: High performance GPU based physics simulation for robot learning. In \textit{Thirty-fifth Conference on Neural Information Processing Systems Datasets and Benchmarks Track (Round 2)}, 2021.
